<x-app-layout>
    <div class="container mx-auto mt-5 px-6">
        <div class="flex space-x-4 mb-6">
            <a href="{{ url('roles') }}"
                class="bg-indigo-600 text-white py-3 px-6 rounded-md shadow-lg hover:bg-indigo-500 transition-all duration-300">Roles</a>
            ...
            <a href="{{ url('users') }}"
                class="bg-yellow-600 text-white py-3 px-6 rounded-md shadow-lg hover:bg-yellow-500 transition-all duration-300">Trabajadores</a>
        </div>
